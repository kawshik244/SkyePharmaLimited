...
ResultSet Rs = null,Rs1 = null;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Manage Agent for____________________________________________________________________");
        ...
        AgentTable.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 153, 153)));
        ...
        AgentTable.setSelectionBackground(new java.awt.Color(153, 255, 153));
...
public void SelectMed()
 {
    ...
    private void UpdateBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UpdateBtnMouseClicked
        ...
        else
        {
            try{
               Con = DriverManager.getConnection("jdbc:mysql://localhost:3306/mysql","root","kawshik244");
               String UpdateQuery = "Update mysql.AGENTTBL set ANAME = '"+Aname.getText()+"'"+",AAGE = '"+Aage.getText()+"'"+",APHONE = '"+Aphone.getText()+"'"+",APASS = '"+Apass.getText()+"'"+",AGENDER = '"+GenderCb.getSelectedItem().toString()+"'"+"where AID = "+Aid.getText();
